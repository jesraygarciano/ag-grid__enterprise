...
const GroupFlagCellRenderer: React.FC<GroupFlagCellRendererParams> = (
  props
) => {
...
GroupFlagCellRenderer.displayName = "GroupFlagCellRenderer";

export default GroupFlagCellRenderer;
